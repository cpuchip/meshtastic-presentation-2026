# Speaker notes (Michael's, hidden in the deck; press N)

One `## Slide N` section per slide, keyed to the numbering of site/meshtastic.md.
Every paragraph under a heading becomes a hidden note on that slide when
scripts/sync-slides.py regenerates slides/slides.md. Slide text itself lives in
site/meshtastic.md; do not edit slides.md by hand, it is generated.
